...
//		ArgUtils::valEnum($name, self::getNames());
	...
	public function getParameterQueryItem(): ?QueryItem {
		return $this->parameterQueryItem;
	}
	
	public function buildItem(QueryFragmentBuilder $fragmentBuilder): void {
		$fragmentBuilder->openFunction($this->name);
		if (isset($this->parameterQueryItem)) {
			$this->parameterQueryItem->buildItem($fragmentBuilder);
		}
		$fragmentBuilder->closeFunction();
	}
